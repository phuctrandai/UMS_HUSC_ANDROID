...
public class LICHSUBANTHAN {
    ...
    public int getNamTotNghiepTHPT() {
        return NamTotNghiepTHPT;
    }

    public void setNamTotNghiepTHPT(int namTotNghiepTHPT) {
    ...
    public LICHSUBANTHAN(String maSinhVien, int namTotNghiepTHPT, String xepLoaiTotNghiepTHPT,
                         String noiTotNghiepTHPT, String xepLoaiHocTap10, String xepLoaiHocTap11,
                         String xepLoaiHocTap12, String xepLoaiHanhKiem10, String xepLoaiHanhKiem11,
                         String xepLoaiHanhKiem12, String tenLucLuongVuTrang, String ngayBatDauLLVT,
                         String ngayKetThucLLVT, String quanHamLLVT, String noiCongTacLLVT) {
        MaSinhVien = maSinhVien;
        NamTotNghiepTHPT = namTotNghiepTHPT;
        XepLoaiTotNghiepTHPT = xepLoaiTotNghiepTHPT;
        NoiTotNghiepTHPT = noiTotNghiepTHPT;
